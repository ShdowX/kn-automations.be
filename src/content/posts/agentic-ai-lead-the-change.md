...
1. We map out existing processes (usually inefficient ones)
2. We identify steps where we *could* insert AI
3. We add AI to those steps and hope productivity magically increases
...
![Process Redesign Comparison](/images/blog/bolted-on-vs-built-around.svg)
...
1. Employee receives PDF by email
2. Opens it, reads it, checks for issues
3. If everything looks good, manually processes it into accounting software
4. If there's a problem, escalates it
...
Originally published on [Cegeka's blog](https://www.cegeka.com/en/blogs/agentic-ai-lead-the-change).
